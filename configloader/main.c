...
static int deserialize_test(void) {
    FILE* cfg1 = open_input_file("test/testconfig.cfg");
    FILE* cfg2 = open_input_file("test/testconfig2.cfg");
...
static int merge_test(void) {
    FILE* cfg1 = open_input_file("test/merge1.cfg");
    FILE* cfg2 = open_input_file("test/merge2.cfg");
